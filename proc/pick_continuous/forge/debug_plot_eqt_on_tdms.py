...
EQT_WEIGHTS = 'original'  #'/workspace/model_weight/010_Train_EqT_FT-STEAD_rot30_Hinet selftrain.pth'
EQT_IN_SAMPLES = 6000
EQT_BATCH_TRACES = 64
...
title = (
	f'Amplitude + P(solid)/S(dashed) | start={_iso_utc(first_window_start_ms)} | '
