...
CH_TABLE_BY_NETWORK: dict[str, Path] = {
	'0101': Path(
		'/workspace/proc/izu2009/prepare_data/download_continuous/continuous_ch47/0101/win_0101_200912170000_10m_aa3c27a4.ch'
	),
	'0203': Path(
		'/workspace/proc/izu2009/prepare_data/download_continuous/continuous_ch47/0203/win_0203_200912170000_10m_9a3c463f.ch'
	),
	'0207': Path(
		'/workspace/proc/izu2009/prepare_data/download_continuous/continuous_ch47/0207/win_0207_200912170000_10m_1c7df708.ch'
	),
	'0301': Path(
		'/workspace/proc/izu2009/prepare_data/download_continuous/continuous_ch47/0301/win_0301_200912170000_10m_4dd999af.ch'
	),
}
