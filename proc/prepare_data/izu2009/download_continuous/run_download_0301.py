# %%
# proc/prepare_data/jma/izu2009/run_download_0301.py
...
if __name__ == '__main__':
	...
	# 0301はselect非対応なので、このリストでサーバ側が絞られることは期待しない（=全局DL）。
	stations_txt = Path('../profile/stations47/stations_0301.txt')

	# 出力先（0301だけ別ディレクトリに）
	out_dir = Path('/workspace/data/izu2009/continuous/0301')
	...
	while cur < t_end:
		...
		download_win_for_stations(
			...
			use_select=select_supported,  # 0301はFalse想定
			data_name=data_name,
