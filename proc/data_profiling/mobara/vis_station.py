...
def plot_stations_by_affiliation_from_station_csv(
	...
	*,
	...
	params = load_plot_preset('/workspace/data/config/plot_config.yaml', config_name)
	minx, maxx = params['lon_range']
	miny, maxy = params['lat_range']
